# ZAP Report-Phase 4, Booking System - 1st test
...
* URL: http://localhost:8000/accountInfo
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
...
* URL: http://localhost:8000/resourcesList
  ...
  * Attack: ``
  * Evidence: `select`
  * Other Info: `The following pattern was used: \bSELECT\b and was detected 2 times, the first in the element starting with: "<!--","resource_description":"test"},{"resource_id":495,"resource_name":"]]>","resource_description":"test"},{"resource_id":496,", see evidence field for the suspicious comment/snippet.`
...
* URL: http://localhost:8000/login
  ...
  * Other Info: `The origin domain used for comparison was:
localhost
session_id=5bfdf794-1edf-4dd6-ae42-dab641427ed3
`
* URL: http://localhost:8000/login
  * Method: `POST`
  * Parameter: ``
  ...
  * Other Info: `The origin domain used for comparison was:
localhost
session_id=90b3b56f-5639-48b0-a83c-2d96c8fe77ae
`
...
* URL: http://localhost:8000/login
  ...
  * Attack: ``
  * Evidence: `5bfdf794-1edf-4dd6-ae42-dab641427ed3`
  * Other Info: `
cookie:session_id`
* URL: http://localhost:8000/login
  * Method: `POST`
  * Parameter: `session_id`
  * Attack: ``
  * Evidence: `90b3b56f-5639-48b0-a83c-2d96c8fe77ae`
  * Other Info: `
cookie:session_id`
* URL: http://localhost:8000/login
  * Method: `GET`
